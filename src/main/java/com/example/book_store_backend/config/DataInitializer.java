...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeBooks() {
        List<Book> books = Arrays.asList(
            ...
            createBook("The Great Gatsby", "F. Scott Fitzgerald",
                      ...
                      new BigDecimal("17.75"), "anglais", "Fiction"),

            createBook("Harry Potter à l'école des sorciers", "J.K. Rowling",
                      "Le jour de ses onze ans, Harry Potter, un orphelin élevé par un oncle et une tante qui le détestent, voit sa vie changer.",
                      new BigDecimal("19.99"), "francais", "Fantasy"),
            ...
            createBook("Sapiens", "Yuval Noah Harari",
                      ...
                      new BigDecimal("24.90"), "francais", "Histoire")
        );
    ...
    private Book createBook(String title, String author, String description,
                           BigDecimal price, String language, String category) {
        Book book = new Book();
        book.setTitle(title);
        ...
        book.setImage(null); // Pas d'image par défaut, sera ajoutée via l'interface
